...
export default function CardHero(props) {
    ...
    return (
        <Grid item
              ...
              style={{margin: 10}}
        >
        <Card key={props.i} className={classes.root}
        >
            <CardContent>
